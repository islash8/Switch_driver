...
/* -------------------------------> Port A <----------------------------------------*/
#define DIO_u8_PIN0_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN1_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN2_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN3_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN4_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN5_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN6_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
#define DIO_u8_PIN7_INIT_DIR	DIO_PIN_INIT_DIR_OUTPUT
...
/* -------------------------------> Port D <----------------------------------------*/
#define DIO_u8_PIN24_INIT_PORT_VAL	DIO_PIN_INIT_VAL_LOW
#define DIO_u8_PIN25_INIT_PORT_VAL	DIO_PIN_INIT_VAL_LOW
#define DIO_u8_PIN26_INIT_PORT_VAL	DIO_PIN_INIT_VAL_LOW
#define DIO_u8_PIN27_INIT_PORT_VAL	DIO_PIN_INIT_VAL_LOW
#define DIO_u8_PIN28_INIT_PORT_VAL	DIO_PIN_INIT_VAL_LOW
#define DIO_u8_PIN29_INIT_PORT_VAL	DIO_PIN_INIT_VAL_LOW
#define DIO_u8_PIN30_INIT_PORT_VAL	DIO_PIN_INIT_VAL_LOW
